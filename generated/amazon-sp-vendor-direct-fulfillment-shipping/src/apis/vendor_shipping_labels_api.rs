...
pub async fn get_shipping_label(configuration: &configuration::Configuration, purchase_order_number: &str) -> Result<crate::models::GetShippingLabelResponse, Error> {
...
pub async fn get_shipping_labels(configuration: &configuration::Configuration, created_after: String, created_before: String, ship_from_party_id: Option<&str>, limit: Option<i32>, sort_order: Option<&str>, next_token: Option<&str>) -> Result<crate::models::GetShippingLabelListResponse, Error> {
    let local_var_configuration = configuration;
...
pub async fn submit_shipping_label_request(configuration: &configuration::Configuration, body: crate::models::SubmitShippingLabelsRequest) -> Result<crate::models::SubmitShippingLabelsResponse, Error> {
    let local_var_configuration = configuration;
