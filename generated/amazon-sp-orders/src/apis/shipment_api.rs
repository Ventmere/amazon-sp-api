...
pub async fn update_shipment_status(configuration: &configuration::Configuration, order_id: &str, payload: crate::models::UpdateShipmentStatusRequest) -> Result<(), Error> {
