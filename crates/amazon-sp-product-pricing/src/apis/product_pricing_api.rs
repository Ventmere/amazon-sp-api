...
pub async fn get_competitive_pricing(configuration: &configuration::Configuration, marketplace_id: &str, item_type: &str, asins: Option<Vec<String>>, skus: Option<Vec<String>>, customer_type: Option<&str>) -> Result<crate::models::GetPricingResponse, Error<GetCompetitivePricingError>> {
    ...
    if let Some(ref local_var_str) = asins {
        local_var_req_builder = match "csv" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("Asins".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("Asins", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = skus {
        local_var_req_builder = match "csv" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("Skus".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("Skus", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = customer_type {
        local_var_req_builder = local_var_req_builder.query(&[("CustomerType", &local_var_str.to_string())]);
    }
...
pub async fn get_item_offers(configuration: &configuration::Configuration, marketplace_id: &str, item_condition: &str, asin: &str, customer_type: Option<&str>) -> Result<crate::models::GetOffersResponse, Error<GetItemOffersError>> {
    ...
    local_var_req_builder = local_var_req_builder.query(&[("MarketplaceId", &marketplace_id.to_string())]);
    local_var_req_builder = local_var_req_builder.query(&[("ItemCondition", &item_condition.to_string())]);
    if let Some(ref local_var_str) = customer_type {
        local_var_req_builder = local_var_req_builder.query(&[("CustomerType", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
...
pub async fn get_pricing(configuration: &configuration::Configuration, marketplace_id: &str, item_type: &str, asins: Option<Vec<String>>, skus: Option<Vec<String>>, item_condition: Option<&str>, offer_type: Option<&str>) -> Result<crate::models::GetPricingResponse, Error<GetPricingError>> {
    ...
    if let Some(ref local_var_str) = item_condition {
        local_var_req_builder = local_var_req_builder.query(&[("ItemCondition", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = offer_type {
        local_var_req_builder = local_var_req_builder.query(&[("OfferType", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
