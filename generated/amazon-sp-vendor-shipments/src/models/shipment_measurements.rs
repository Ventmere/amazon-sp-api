...
pub struct ShipmentMeasurements {
    #[serde(default, rename = "grossShipmentWeight", skip_serializing_if = "Option::is_none")]
    pub gross_shipment_weight: Option<Box<crate::models::Weight>>,
    #[serde(default, rename = "shipmentVolume", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, rename = "palletCount", skip_serializing_if = "Option::is_none")]
