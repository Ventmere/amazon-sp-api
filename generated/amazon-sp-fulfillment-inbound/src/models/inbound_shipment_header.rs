...
pub struct InboundShipmentHeader {
    ...
    #[serde(default, rename = "ShipmentName")]
    ...
    #[serde(default, rename = "AreCasesRequired", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, rename = "IntendedBoxContentsSource", skip_serializing_if = "Option::is_none")]
