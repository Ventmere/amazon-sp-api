...
pub async fn submit_invoice(configuration: &configuration::Configuration, body: crate::models::SubmitInvoiceRequest) -> Result<crate::models::SubmitInvoiceResponse, Error> {
