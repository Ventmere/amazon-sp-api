...
pub async fn submit_inventory_update(configuration: &configuration::Configuration, warehouse_id: &str, body: crate::models::SubmitInventoryUpdateRequest) -> Result<crate::models::SubmitInventoryUpdateResponse, Error> {
