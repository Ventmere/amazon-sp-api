...
pub async fn submit_invoices(configuration: &configuration::Configuration, body: crate::models::SubmitInvoicesRequest) -> Result<crate::models::SubmitInvoicesResponse, Error> {
