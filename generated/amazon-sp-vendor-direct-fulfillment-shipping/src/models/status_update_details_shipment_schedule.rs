...
pub struct StatusUpdateDetailsShipmentSchedule {
    ...
    #[serde(default, rename = "estimatedDeliveryDateTime", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, rename = "apptWindowStartDateTime", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, rename = "apptWindowEndDateTime", skip_serializing_if = "Option::is_none")]
