...
pub struct ListContentDocumentAsinRelationsResponse {
...
impl ListContentDocumentAsinRelationsResponse {
    pub fn new(asin_metadata_set: Vec<crate::models::AsinMetadata>) -> ListContentDocumentAsinRelationsResponse {
