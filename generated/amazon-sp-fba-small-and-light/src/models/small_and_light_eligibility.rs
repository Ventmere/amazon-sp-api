...
pub struct SmallAndLightEligibility {
    ...
    #[serde(rename = "status")]
    pub status: crate::models::SmallAndLightEligibilityStatus,
}

impl SmallAndLightEligibility {
    /// The Small and Light eligibility status of the item indicated by the specified seller SKU.
    pub fn new(marketplace_id: String, seller_sku: String, status: crate::models::SmallAndLightEligibilityStatus) -> SmallAndLightEligibility {
